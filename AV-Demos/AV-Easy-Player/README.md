...
AV-Easy-Player 是一个基于 C++、FFmpeg 和 SDL2 实现的简易音视频播放器 Demo。项目主要用于学习音视频播放器的基础流程，包括媒体文件解封装、音视频解码、音频播放、视频渲染、线程通信以及音视频同步等核心技术。
...
```bash
./build/av_easy_player test.mp4
```

也可以传入绝对路径：

```bash
./build/av_easy_player /home/yourname/Videos/test.mp4
```
